Feature: Offering incentives
  ...
  Scenario: Free shipping for order over $100 and contain gascans
    Given an item named 'Gascan'
    And an incentive named 'free shipping'
    And 'free shipping' is given for orders over $100
    And 'free shipping' is given for orders containing 'Gascan'
    And I have a cart
    When I add an item that costs $101 to my cart
    Then I should not qualify for 'free shipping'
    When I add 'Gascan' to my cart
    Then I should qualify for 'free shipping'
